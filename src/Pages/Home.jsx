                            ...
                            {products?.map(product => (
                                <Col className="li-products"  key={product.id}>
                                    <Card className="card-product__detail" >
                                        ...
                                        <Card.Img className="card-detail__img1" variant="top" src={product?.images[0]?.url} alt='' />
                                        <Card.Img className="card-detail__img2"  variant="top" src={product?.images[1]?.url} alt='' />
                                        </div>
